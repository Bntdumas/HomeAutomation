...
#include "homeNetwork_global.h"

/**
 * @brief The homeNetwork class handles communication with the wifi enabled modules.
...
class HOMENETWORKSHARED_EXPORT homeNetwork: public QObject
{
    Q_OBJECT
public:
    explicit homeNetwork(QObject *parent = 0);
    ~homeNetwork();
